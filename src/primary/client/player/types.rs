...
use crate::primary::parsers::update_block_parser::types::UpdateFields;
...
impl Serialize for FieldValue {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: Serializer {
        match *self {
            FieldValue::Integer(value) => serializer.serialize_u32(value),
...
impl ObjectField {
    ...
    pub fn get_field_type(field_index: u32) -> FieldType {
        match field_index {
            ...
            ObjectField::ENTRY => FieldType::Integer,
...
impl UnitField {
    ...
    pub fn get_field_type(field_index: u32) -> FieldType {
        match field_index {
            ...
            UnitField::CHANNEL_SPELL => FieldType::Integer,
            UnitField::BYTES_0 => FieldType::Bytes,
            UnitField::HEALTH => FieldType::Integer,
            UnitField::POWER1 => FieldType::Integer,
            UnitField::POWER2 => FieldType::Integer,
            UnitField::POWER3 => FieldType::Integer,
            UnitField::POWER4 => FieldType::Integer,
            UnitField::POWER5 => FieldType::Integer,
            UnitField::POWER6 => FieldType::Integer,
            UnitField::POWER7 => FieldType::Integer,
            UnitField::MAXHEALTH => FieldType::Integer,
            UnitField::MAXPOWER1 => FieldType::Integer,
            UnitField::MAXPOWER2 => FieldType::Integer,
            UnitField::MAXPOWER3 => FieldType::Integer,
            UnitField::MAXPOWER4 => FieldType::Integer,
            UnitField::MAXPOWER5 => FieldType::Integer,
            UnitField::MAXPOWER6 => FieldType::Integer,
            UnitField::MAXPOWER7 => FieldType::Integer,
            UnitField::POWER_REGEN_FLAT_MODIFIER => FieldType::Float,
            UnitField::POWER_REGEN_INTERRUPTED_FLAT_MODIFIER => FieldType::Float,
            UnitField::LEVEL => FieldType::Integer,
            UnitField::FACTIONTEMPLATE => FieldType::Integer,
            UnitField::VIRTUAL_ITEM_SLOT_ID1 => FieldType::Integer,
            UnitField::VIRTUAL_ITEM_SLOT_ID2 => FieldType::Integer,
            UnitField::VIRTUAL_ITEM_SLOT_ID3 => FieldType::Integer,
            UnitField::FLAGS => FieldType::Integer,
            UnitField::FLAGS_2 => FieldType::Integer,
            UnitField::AURASTATE => FieldType::Integer,
            UnitField::BASEATTACKTIME => FieldType::Integer,
            UnitField::UNK63 => FieldType::Integer,
            UnitField::RANGEDATTACKTIME => FieldType::Integer,
            UnitField::BOUNDINGRADIUS => FieldType::Float,
            UnitField::COMBATREACH => FieldType::Float,
            UnitField::DISPLAYID => FieldType::Integer,
            UnitField::NATIVEDISPLAYID => FieldType::Integer,
            UnitField::MOUNTDISPLAYID => FieldType::Integer,
            ...
            UnitField::BYTES_1 => FieldType::Bytes,
            UnitField::PETNUMBER => FieldType::Integer,
            UnitField::PET_NAME_TIMESTAMP => FieldType::Integer,
            UnitField::PETEXPERIENCE => FieldType::Integer,
            UnitField::PETNEXTLEVELEXP => FieldType::Integer,
            UnitField::DYNAMIC_FLAGS => FieldType::Integer,
            UnitField::MOD_CAST_SPEED => FieldType::Float,
            UnitField::CREATED_BY_SPELL => FieldType::Integer,
            UnitField::NPC_FLAGS => FieldType::Integer,
            UnitField::NPC_EMOTESTATE => FieldType::Integer,
            UnitField::STAT0 => FieldType::Integer,
            UnitField::STAT1 => FieldType::Integer,
            UnitField::STAT2 => FieldType::Integer,
            UnitField::STAT3 => FieldType::Integer,
            UnitField::STAT4 => FieldType::Integer,
            UnitField::POSSTAT0 => FieldType::Integer,
            UnitField::POSSTAT1 => FieldType::Integer,
            UnitField::POSSTAT2 => FieldType::Integer,
            UnitField::POSSTAT3 => FieldType::Integer,
            UnitField::POSSTAT4 => FieldType::Integer,
            UnitField::NEGSTAT0 => FieldType::Integer,
            UnitField::NEGSTAT1 => FieldType::Integer,
            UnitField::NEGSTAT2 => FieldType::Integer,
            UnitField::NEGSTAT3 => FieldType::Integer,
            UnitField::NEGSTAT4 => FieldType::Integer,
            UnitField::RESISTANCES_ARMOR => FieldType::Integer,
            UnitField::RESISTANCES_HOLY => FieldType::Integer,
            UnitField::RESISTANCES_FIRE => FieldType::Integer,
            UnitField::RESISTANCES_NATURE => FieldType::Integer,
            UnitField::RESISTANCES_FROST => FieldType::Integer,
            UnitField::RESISTANCES_SHADOW => FieldType::Integer,
            UnitField::RESISTANCES_ARCANE => FieldType::Integer,
            UnitField::RESISTANCEBUFFMODSPOSITIVE_ARMOR => FieldType::Integer,
            UnitField::RESISTANCEBUFFMODSPOSITIVE_HOLY => FieldType::Integer,
            UnitField::RESISTANCEBUFFMODSPOSITIVE_FIRE => FieldType::Integer,
            UnitField::RESISTANCEBUFFMODSPOSITIVE_NATURE => FieldType::Integer,
            UnitField::RESISTANCEBUFFMODSPOSITIVE_FROST => FieldType::Integer,
            UnitField::RESISTANCEBUFFMODSPOSITIVE_SHADOW => FieldType::Integer,
            UnitField::RESISTANCEBUFFMODSPOSITIVE_ARCANE => FieldType::Integer,
            UnitField::RESISTANCEBUFFMODSNEGATIVE_ARMOR => FieldType::Integer,
            UnitField::RESISTANCEBUFFMODSNEGATIVE_HOLY => FieldType::Integer,
            UnitField::RESISTANCEBUFFMODSNEGATIVE_FIRE => FieldType::Integer,
            UnitField::RESISTANCEBUFFMODSNEGATIVE_NATURE => FieldType::Integer,
            UnitField::RESISTANCEBUFFMODSNEGATIVE_FROST => FieldType::Integer,
            UnitField::RESISTANCEBUFFMODSNEGATIVE_SHADOW => FieldType::Integer,
            UnitField::RESISTANCEBUFFMODSNEGATIVE_ARCANE => FieldType::Integer,
            UnitField::BASE_MANA => FieldType::Integer,
            UnitField::BASE_HEALTH => FieldType::Integer,
            UnitField::BYTES_2 => FieldType::Bytes,
            UnitField::ATTACK_POWER => FieldType::Integer,
            UnitField::ATTACK_POWER_MODS => FieldType::TwoShorts,
            UnitField::ATTACK_POWER_MULTIPLIER => FieldType::Float,
            UnitField::RANGED_ATTACK_POWER => FieldType::Integer,
            UnitField::RANGED_ATTACK_POWER_MODS => FieldType::TwoShorts,
            ...
            UnitField::POWER_COST_MODIFIER => FieldType::Integer,
...
impl PlayerField {
    ...
    pub const PAD_0: u32 = 323;
    pub const INV_SLOT_HEAD: u32 = 324;
    pub const INV_SLOT_FIXME1: u32 = 326;
    pub const INV_SLOT_FIXME2: u32 = 328;
    pub const INV_SLOT_FIXME3: u32 = 330;
    pub const INV_SLOT_FIXME4: u32 = 332;
    pub const INV_SLOT_FIXME5: u32 = 334;
    pub const INV_SLOT_FIXME6: u32 = 336;
    pub const INV_SLOT_FIXME7: u32 = 338;
    pub const INV_SLOT_FIXME8: u32 = 340;
    pub const INV_SLOT_FIXME9: u32 = 342;
    pub const INV_SLOT_FIXME10: u32 = 344;
    pub const INV_SLOT_FIXME11: u32 = 346;
    pub const INV_SLOT_FIXME12: u32 = 348;
    pub const INV_SLOT_FIXME13: u32 = 350;
    pub const INV_SLOT_FIXME14: u32 = 352;
    pub const INV_SLOT_FIXME15: u32 = 354;
    pub const INV_SLOT_FIXME16: u32 = 356;
    pub const INV_SLOT_FIXME17: u32 = 358;
    pub const INV_SLOT_FIXME18: u32 = 360;
    pub const INV_SLOT_FIXME19: u32 = 362;
    pub const INV_SLOT_FIXME20: u32 = 364;
    pub const INV_SLOT_FIXME21: u32 = 366;
    pub const INV_SLOT_FIXME22: u32 = 368;
    pub const PACK_SLOT_1: u32 = 370;
    pub const BANK_SLOT_1: u32 = 402;
    pub const BANKBAG_SLOT_1: u32 = 458;
    pub const VENDORBUYBACK_SLOT_1: u32 = 472;
    pub const KEYRING_SLOT_1: u32 = 496;
    pub const CURRENCYTOKEN_SLOT_1: u32 = 560;
    pub const FARSIGHT: u32 = 624;
    pub const KNOWN_TITLES: u32 = 626;
    pub const KNOWN_TITLES1: u32 = 628;
    pub const KNOWN_TITLES2: u32 = 630;
    pub const KNOWN_CURRENCIES: u32 = 632;
    ...
    pub const COINAGE: u32 = 1170;
    pub const MOD_DAMAGE_DONE_POS: u32 = 1171;
    pub const MOD_DAMAGE_DONE_NEG: u32 = 1178;
    pub const MOD_DAMAGE_DONE_PCT1: u32 = 1185;
    pub const MOD_DAMAGE_DONE_PCT2: u32 = 1186;
    pub const MOD_DAMAGE_DONE_PCT3: u32 = 1187;
    pub const MOD_DAMAGE_DONE_PCT4: u32 = 1188;
    pub const MOD_DAMAGE_DONE_PCT5: u32 = 1189;
    pub const MOD_DAMAGE_DONE_PCT6: u32 = 1190;
    pub const MOD_DAMAGE_DONE_PCT7: u32 = 1191;
    pub const MOD_HEALING_DONE_POS: u32 = 1192;
    pub const MOD_HEALING_PCT: u32 = 1193;
    pub const MOD_HEALING_DONE_PCT: u32 = 1194;
    pub const MOD_TARGET_RESISTANCE: u32 = 1195;
    pub const MOD_TARGET_PHYSICAL_RESISTANCE: u32 = 1196;
    pub const FIELD_BYTES: u32 = 1197;
    pub const AMMO_ID: u32 = 1198;
    pub const SELF_RES_SPELL: u32 = 1199;
    pub const PVP_MEDALS: u32 = 1200;
    pub const BUYBACK_PRICE_1: u32 = 1201;
    pub const BUYBACK_PRICE_2: u32 = 1202;
    pub const BUYBACK_PRICE_3: u32 = 1203;
    pub const BUYBACK_PRICE_4: u32 = 1204;
    pub const BUYBACK_PRICE_5: u32 = 1205;
    pub const BUYBACK_PRICE_6: u32 = 1206;
    pub const BUYBACK_PRICE_7: u32 = 1207;
    pub const BUYBACK_PRICE_8: u32 = 1208;
    pub const BUYBACK_PRICE_9: u32 = 1209;
    pub const BUYBACK_PRICE_10: u32 = 1210;
    pub const BUYBACK_PRICE_11: u32 = 1211;
    pub const BUYBACK_PRICE_12: u32 = 1212;
    pub const BUYBACK_TIMESTAMP_1: u32 = 1213;
    pub const BUYBACK_TIMESTAMP_2: u32 = 1214;
    pub const BUYBACK_TIMESTAMP_3: u32 = 1215;
    pub const BUYBACK_TIMESTAMP_4: u32 = 1216;
    pub const BUYBACK_TIMESTAMP_5: u32 = 1217;
    pub const BUYBACK_TIMESTAMP_6: u32 = 1218;
    pub const BUYBACK_TIMESTAMP_7: u32 = 1219;
    pub const BUYBACK_TIMESTAMP_8: u32 = 1220;
    pub const BUYBACK_TIMESTAMP_9: u32 = 1221;
    pub const BUYBACK_TIMESTAMP_10: u32 = 1222;
    pub const BUYBACK_TIMESTAMP_11: u32 = 1223;
    pub const BUYBACK_TIMESTAMP_12: u32 = 1224;
    pub const KILLS: u32 = 1225;
    pub const TODAY_CONTRIBUTION: u32 = 1226;
    pub const YESTERDAY_CONTRIBUTION: u32 = 1227;
    pub const LIFETIME_HONORABLE_KILLS: u32 = 1228;
    pub const FIELD_BYTES2: u32 = 1229;
    pub const WATCHED_FACTION_INDEX: u32 = 1230;
    pub const COMBAT_RATING_1: u32 = 1231;
    pub const ARENA_TEAM_INFO_1_1: u32 = 1256;
    pub const HONOR_CURRENCY: u32 = 1277;
    pub const ARENA_CURRENCY: u32 = 1278;
    pub const MAX_LEVEL: u32 = 1279;
    pub const DAILY_QUESTS_1: u32 = 1280;
    ...
    pub const GLYPH_SLOTS_1: u32 = 1312;
    pub const GLYPH_SLOTS_2: u32 = 1313;
    pub const GLYPH_SLOTS_3: u32 = 1314;
    pub const GLYPH_SLOTS_4: u32 = 1315;
    pub const GLYPH_SLOTS_5: u32 = 1316;
    pub const GLYPH_SLOTS_6: u32 = 1317;
    pub const GLYPHS_1: u32 = 1318;
    pub const GLYPHS_2: u32 = 1319;
    pub const GLYPHS_3: u32 = 1320;
    pub const GLYPHS_4: u32 = 1321;
    pub const GLYPHS_5: u32 = 1322;
    pub const GLYPHS_6: u32 = 1323;
    ...
    pub fn get_field_type(field_index: u32) -> FieldType {
        match field_index {
            ...
            PlayerField::FLAGS => FieldType::Integer,
            PlayerField::GUILDID => FieldType::Integer,
            PlayerField::GUILDRANK => FieldType::Integer,
            PlayerField::BYTES => FieldType::Bytes,
            PlayerField::BYTES_2 => FieldType::Bytes,
            PlayerField::BYTES_3 => FieldType::Bytes,
            PlayerField::DUEL_TEAM => FieldType::Integer,
            PlayerField::GUILD_TIMESTAMP => FieldType::Integer,
            PlayerField::QUEST_LOG_1_1 => FieldType::Integer,
            PlayerField::QUEST_LOG_1_2 => FieldType::Integer,
            PlayerField::QUEST_LOG_1_3 => FieldType::TwoShorts,
            PlayerField::QUEST_LOG_1_4 => FieldType::Integer,
            PlayerField::QUEST_LOG_2_1 => FieldType::Integer,
            PlayerField::QUEST_LOG_2_2 => FieldType::Integer,
            PlayerField::QUEST_LOG_2_3 => FieldType::TwoShorts,
            PlayerField::QUEST_LOG_2_5 => FieldType::Integer,
            PlayerField::QUEST_LOG_3_1 => FieldType::Integer,
            PlayerField::QUEST_LOG_3_2 => FieldType::Integer,
            PlayerField::QUEST_LOG_3_3 => FieldType::TwoShorts,
            PlayerField::QUEST_LOG_3_5 => FieldType::Integer,
            PlayerField::QUEST_LOG_4_1 => FieldType::Integer,
            PlayerField::QUEST_LOG_4_2 => FieldType::Integer,
            PlayerField::QUEST_LOG_4_3 => FieldType::TwoShorts,
            PlayerField::QUEST_LOG_4_5 => FieldType::Integer,
            PlayerField::QUEST_LOG_5_1 => FieldType::Integer,
            PlayerField::QUEST_LOG_5_2 => FieldType::Integer,
            PlayerField::QUEST_LOG_5_3 => FieldType::TwoShorts,
            PlayerField::QUEST_LOG_5_5 => FieldType::Integer,
            PlayerField::QUEST_LOG_6_1 => FieldType::Integer,
            PlayerField::QUEST_LOG_6_2 => FieldType::Integer,
            PlayerField::QUEST_LOG_6_3 => FieldType::TwoShorts,
            PlayerField::QUEST_LOG_6_5 => FieldType::Integer,
            PlayerField::QUEST_LOG_7_1 => FieldType::Integer,
            PlayerField::QUEST_LOG_7_2 => FieldType::Integer,
            PlayerField::QUEST_LOG_7_3 => FieldType::TwoShorts,
            PlayerField::QUEST_LOG_7_5 => FieldType::Integer,
            PlayerField::QUEST_LOG_8_1 => FieldType::Integer,
            PlayerField::QUEST_LOG_8_2 => FieldType::Integer,
            PlayerField::QUEST_LOG_8_3 => FieldType::TwoShorts,
            PlayerField::QUEST_LOG_8_5 => FieldType::Integer,
            PlayerField::QUEST_LOG_9_1 => FieldType::Integer,
            PlayerField::QUEST_LOG_9_2 => FieldType::Integer,
            PlayerField::QUEST_LOG_9_3 => FieldType::TwoShorts,
            PlayerField::QUEST_LOG_9_5 => FieldType::Integer,
            PlayerField::QUEST_LOG_10_1 => FieldType::Integer,
            PlayerField::QUEST_LOG_10_2 => FieldType::Integer,
            PlayerField::QUEST_LOG_10_3 => FieldType::TwoShorts,
            PlayerField::QUEST_LOG_10_5 => FieldType::Integer,
            PlayerField::QUEST_LOG_11_1 => FieldType::Integer,
            PlayerField::QUEST_LOG_11_2 => FieldType::Integer,
            PlayerField::QUEST_LOG_11_3 => FieldType::TwoShorts,
            PlayerField::QUEST_LOG_11_5 => FieldType::Integer,
            PlayerField::QUEST_LOG_12_1 => FieldType::Integer,
            PlayerField::QUEST_LOG_12_2 => FieldType::Integer,
            PlayerField::QUEST_LOG_12_3 => FieldType::TwoShorts,
            PlayerField::QUEST_LOG_12_5 => FieldType::Integer,
            PlayerField::QUEST_LOG_13_1 => FieldType::Integer,
            PlayerField::QUEST_LOG_13_2 => FieldType::Integer,
            PlayerField::QUEST_LOG_13_3 => FieldType::TwoShorts,
            PlayerField::QUEST_LOG_13_5 => FieldType::Integer,
            PlayerField::QUEST_LOG_14_1 => FieldType::Integer,
            PlayerField::QUEST_LOG_14_2 => FieldType::Integer,
            PlayerField::QUEST_LOG_14_3 => FieldType::TwoShorts,
            PlayerField::QUEST_LOG_14_5 => FieldType::Integer,
            PlayerField::QUEST_LOG_15_1 => FieldType::Integer,
            PlayerField::QUEST_LOG_15_2 => FieldType::Integer,
            PlayerField::QUEST_LOG_15_3 => FieldType::TwoShorts,
            PlayerField::QUEST_LOG_15_5 => FieldType::Integer,
            PlayerField::QUEST_LOG_16_1 => FieldType::Integer,
            PlayerField::QUEST_LOG_16_2 => FieldType::Integer,
            PlayerField::QUEST_LOG_16_3 => FieldType::TwoShorts,
            PlayerField::QUEST_LOG_16_5 => FieldType::Integer,
            PlayerField::QUEST_LOG_17_1 => FieldType::Integer,
            PlayerField::QUEST_LOG_17_2 => FieldType::Integer,
            PlayerField::QUEST_LOG_17_3 => FieldType::TwoShorts,
            PlayerField::QUEST_LOG_17_5 => FieldType::Integer,
            PlayerField::QUEST_LOG_18_1 => FieldType::Integer,
            PlayerField::QUEST_LOG_18_2 => FieldType::Integer,
            PlayerField::QUEST_LOG_18_3 => FieldType::TwoShorts,
            PlayerField::QUEST_LOG_18_5 => FieldType::Integer,
            PlayerField::QUEST_LOG_19_1 => FieldType::Integer,
            PlayerField::QUEST_LOG_19_2 => FieldType::Integer,
            PlayerField::QUEST_LOG_19_3 => FieldType::TwoShorts,
            PlayerField::QUEST_LOG_19_5 => FieldType::Integer,
            PlayerField::QUEST_LOG_20_1 => FieldType::Integer,
            PlayerField::QUEST_LOG_20_2 => FieldType::Integer,
            PlayerField::QUEST_LOG_20_3 => FieldType::TwoShorts,
            PlayerField::QUEST_LOG_20_5 => FieldType::Integer,
            PlayerField::QUEST_LOG_21_1 => FieldType::Integer,
            PlayerField::QUEST_LOG_21_2 => FieldType::Integer,
            PlayerField::QUEST_LOG_21_3 => FieldType::TwoShorts,
            PlayerField::QUEST_LOG_21_5 => FieldType::Integer,
            PlayerField::QUEST_LOG_22_1 => FieldType::Integer,
            PlayerField::QUEST_LOG_22_2 => FieldType::Integer,
            PlayerField::QUEST_LOG_22_3 => FieldType::TwoShorts,
            PlayerField::QUEST_LOG_22_5 => FieldType::Integer,
            PlayerField::QUEST_LOG_23_1 => FieldType::Integer,
            PlayerField::QUEST_LOG_23_2 => FieldType::Integer,
            PlayerField::QUEST_LOG_23_3 => FieldType::TwoShorts,
            PlayerField::QUEST_LOG_23_5 => FieldType::Integer,
            PlayerField::QUEST_LOG_24_1 => FieldType::Integer,
            PlayerField::QUEST_LOG_24_2 => FieldType::Integer,
            PlayerField::QUEST_LOG_24_3 => FieldType::TwoShorts,
            PlayerField::QUEST_LOG_24_5 => FieldType::Integer,
            PlayerField::QUEST_LOG_25_1 => FieldType::Integer,
            PlayerField::QUEST_LOG_25_2 => FieldType::Integer,
            PlayerField::QUEST_LOG_25_3 => FieldType::TwoShorts,
            PlayerField::QUEST_LOG_25_5 => FieldType::Integer,
            PlayerField::VISIBLE_ITEM_1_ENTRYID => FieldType::Integer,
            PlayerField::VISIBLE_ITEM_1_ENCHANTMENT => FieldType::TwoShorts,
            PlayerField::VISIBLE_ITEM_2_ENTRYID => FieldType::Integer,
            PlayerField::VISIBLE_ITEM_2_ENCHANTMENT => FieldType::TwoShorts,
            PlayerField::VISIBLE_ITEM_3_ENTRYID => FieldType::Integer,
            PlayerField::VISIBLE_ITEM_3_ENCHANTMENT => FieldType::TwoShorts,
            PlayerField::VISIBLE_ITEM_4_ENTRYID => FieldType::Integer,
            PlayerField::VISIBLE_ITEM_4_ENCHANTMENT => FieldType::TwoShorts,
            PlayerField::VISIBLE_ITEM_5_ENTRYID => FieldType::Integer,
            PlayerField::VISIBLE_ITEM_5_ENCHANTMENT => FieldType::TwoShorts,
            PlayerField::VISIBLE_ITEM_6_ENTRYID => FieldType::Integer,
            PlayerField::VISIBLE_ITEM_6_ENCHANTMENT => FieldType::TwoShorts,
            PlayerField::VISIBLE_ITEM_7_ENTRYID => FieldType::Integer,
            PlayerField::VISIBLE_ITEM_7_ENCHANTMENT => FieldType::TwoShorts,
            PlayerField::VISIBLE_ITEM_8_ENTRYID => FieldType::Integer,
            PlayerField::VISIBLE_ITEM_8_ENCHANTMENT => FieldType::TwoShorts,
            PlayerField::VISIBLE_ITEM_9_ENTRYID => FieldType::Integer,
            PlayerField::VISIBLE_ITEM_9_ENCHANTMENT => FieldType::TwoShorts,
            PlayerField::VISIBLE_ITEM_10_ENTRYID => FieldType::Integer,
            PlayerField::VISIBLE_ITEM_10_ENCHANTMENT => FieldType::TwoShorts,
            PlayerField::VISIBLE_ITEM_11_ENTRYID => FieldType::Integer,
            PlayerField::VISIBLE_ITEM_11_ENCHANTMENT => FieldType::TwoShorts,
            PlayerField::VISIBLE_ITEM_12_ENTRYID => FieldType::Integer,
            PlayerField::VISIBLE_ITEM_12_ENCHANTMENT => FieldType::TwoShorts,
            PlayerField::VISIBLE_ITEM_13_ENTRYID => FieldType::Integer,
            PlayerField::VISIBLE_ITEM_13_ENCHANTMENT => FieldType::TwoShorts,
            PlayerField::VISIBLE_ITEM_14_ENTRYID => FieldType::Integer,
            PlayerField::VISIBLE_ITEM_14_ENCHANTMENT => FieldType::TwoShorts,
            PlayerField::VISIBLE_ITEM_15_ENTRYID => FieldType::Integer,
            PlayerField::VISIBLE_ITEM_15_ENCHANTMENT => FieldType::TwoShorts,
            PlayerField::VISIBLE_ITEM_16_ENTRYID => FieldType::Integer,
            PlayerField::VISIBLE_ITEM_16_ENCHANTMENT => FieldType::TwoShorts,
            PlayerField::VISIBLE_ITEM_17_ENTRYID => FieldType::Integer,
            PlayerField::VISIBLE_ITEM_17_ENCHANTMENT => FieldType::TwoShorts,
            PlayerField::VISIBLE_ITEM_18_ENTRYID => FieldType::Integer,
            PlayerField::VISIBLE_ITEM_18_ENCHANTMENT => FieldType::TwoShorts,
            PlayerField::VISIBLE_ITEM_19_ENTRYID => FieldType::Integer,
            PlayerField::VISIBLE_ITEM_19_ENCHANTMENT => FieldType::TwoShorts,
            PlayerField::CHOSEN_TITLE => FieldType::Integer,
            PlayerField::FAKE_INEBRIATION => FieldType::Integer,
            PlayerField::PAD_0 => FieldType::Integer,
            PlayerField::INV_SLOT_HEAD => FieldType::Long,
            PlayerField::INV_SLOT_FIXME1 => FieldType::Long,
            PlayerField::INV_SLOT_FIXME2 => FieldType::Long,
            PlayerField::INV_SLOT_FIXME3 => FieldType::Long,
            PlayerField::INV_SLOT_FIXME4 => FieldType::Long,
            PlayerField::INV_SLOT_FIXME5 => FieldType::Long,
            PlayerField::INV_SLOT_FIXME6 => FieldType::Long,
            PlayerField::INV_SLOT_FIXME7 => FieldType::Long,
            PlayerField::INV_SLOT_FIXME8 => FieldType::Long,
            PlayerField::INV_SLOT_FIXME9 => FieldType::Long,
            PlayerField::INV_SLOT_FIXME10 => FieldType::Long,
            PlayerField::INV_SLOT_FIXME11 => FieldType::Long,
            PlayerField::INV_SLOT_FIXME12 => FieldType::Long,
            PlayerField::INV_SLOT_FIXME13 => FieldType::Long,
            PlayerField::INV_SLOT_FIXME14 => FieldType::Long,
            PlayerField::INV_SLOT_FIXME15 => FieldType::Long,
            PlayerField::INV_SLOT_FIXME16 => FieldType::Long,
            PlayerField::INV_SLOT_FIXME17 => FieldType::Long,
            PlayerField::INV_SLOT_FIXME18 => FieldType::Long,
            PlayerField::INV_SLOT_FIXME19 => FieldType::Long,
            PlayerField::INV_SLOT_FIXME20 => FieldType::Long,
            PlayerField::INV_SLOT_FIXME21 => FieldType::Long,
            PlayerField::INV_SLOT_FIXME22 => FieldType::Long,
            PlayerField::PACK_SLOT_1 => FieldType::Long,
            PlayerField::BANK_SLOT_1 => FieldType::Long,
            PlayerField::BANKBAG_SLOT_1 => FieldType::Long,
            PlayerField::VENDORBUYBACK_SLOT_1 => FieldType::Long,
            PlayerField::KEYRING_SLOT_1 => FieldType::Long,
            PlayerField::CURRENCYTOKEN_SLOT_1 => FieldType::Long,
            PlayerField::FARSIGHT => FieldType::Long,
            PlayerField::KNOWN_TITLES => FieldType::Long,
            PlayerField::KNOWN_TITLES1 => FieldType::Long,
            PlayerField::KNOWN_TITLES2 => FieldType::Long,
            PlayerField::KNOWN_CURRENCIES => FieldType::Long,
            PlayerField::XP => FieldType::Integer,
            PlayerField::NEXT_LEVEL_XP => FieldType::Integer,
            PlayerField::SKILL_INFO_1_1 => FieldType::TwoShorts,
            PlayerField::CHARACTER_POINTS1 => FieldType::Integer,
            PlayerField::CHARACTER_POINTS2 => FieldType::Integer,
            PlayerField::TRACK_CREATURES => FieldType::Integer,
            PlayerField::TRACK_RESOURCES => FieldType::Integer,
            ...
            PlayerField::EXPERTISE => FieldType::Integer,
            PlayerField::OFFHAND_EXPERTISE => FieldType::Integer,
            ...
            PlayerField::SHIELD_BLOCK => FieldType::Integer,
            PlayerField::SHIELD_BLOCK_CRIT_PERCENTAGE => FieldType::Float,
            PlayerField::EXPLORED_ZONES_1 => FieldType::Bytes,
            PlayerField::REST_STATE_EXPERIENCE => FieldType::Integer,
            PlayerField::COINAGE => FieldType::Integer,
            PlayerField::MOD_DAMAGE_DONE_POS => FieldType::Integer,
            PlayerField::MOD_DAMAGE_DONE_NEG => FieldType::Integer,
            PlayerField::MOD_DAMAGE_DONE_PCT1 => FieldType::Integer,
            PlayerField::MOD_DAMAGE_DONE_PCT2 => FieldType::Integer,
            PlayerField::MOD_DAMAGE_DONE_PCT3 => FieldType::Integer,
            PlayerField::MOD_DAMAGE_DONE_PCT4 => FieldType::Integer,
            PlayerField::MOD_DAMAGE_DONE_PCT5 => FieldType::Integer,
            PlayerField::MOD_DAMAGE_DONE_PCT6 => FieldType::Integer,
            PlayerField::MOD_DAMAGE_DONE_PCT7 => FieldType::Integer,
            PlayerField::MOD_HEALING_DONE_POS => FieldType::Integer,
            PlayerField::MOD_HEALING_PCT => FieldType::Float,
            PlayerField::MOD_HEALING_DONE_PCT => FieldType::Float,
            PlayerField::MOD_TARGET_RESISTANCE => FieldType::Integer,
            PlayerField::MOD_TARGET_PHYSICAL_RESISTANCE => FieldType::Integer,
            PlayerField::FIELD_BYTES => FieldType::Bytes,
            PlayerField::AMMO_ID => FieldType::Long,
            PlayerField::SELF_RES_SPELL => FieldType::Integer,
            PlayerField::PVP_MEDALS => FieldType::Integer,
            PlayerField::BUYBACK_PRICE_1 => FieldType::Integer,
            PlayerField::BUYBACK_PRICE_2 => FieldType::Integer,
            PlayerField::BUYBACK_PRICE_3 => FieldType::Integer,
            PlayerField::BUYBACK_PRICE_4 => FieldType::Integer,
            PlayerField::BUYBACK_PRICE_5 => FieldType::Integer,
            PlayerField::BUYBACK_PRICE_6 => FieldType::Integer,
            PlayerField::BUYBACK_PRICE_7 => FieldType::Integer,
            PlayerField::BUYBACK_PRICE_8 => FieldType::Integer,
            PlayerField::BUYBACK_PRICE_9 => FieldType::Integer,
            PlayerField::BUYBACK_PRICE_10 => FieldType::Integer,
            PlayerField::BUYBACK_PRICE_11 => FieldType::Integer,
            PlayerField::BUYBACK_PRICE_12 => FieldType::Integer,
            PlayerField::BUYBACK_TIMESTAMP_1 => FieldType::Integer,
            PlayerField::BUYBACK_TIMESTAMP_2 => FieldType::Integer,
            PlayerField::BUYBACK_TIMESTAMP_3 => FieldType::Integer,
            PlayerField::BUYBACK_TIMESTAMP_4 => FieldType::Integer,
            PlayerField::BUYBACK_TIMESTAMP_5 => FieldType::Integer,
            PlayerField::BUYBACK_TIMESTAMP_6 => FieldType::Integer,
            PlayerField::BUYBACK_TIMESTAMP_7 => FieldType::Integer,
            PlayerField::BUYBACK_TIMESTAMP_8 => FieldType::Integer,
            PlayerField::BUYBACK_TIMESTAMP_9 => FieldType::Integer,
            PlayerField::BUYBACK_TIMESTAMP_10 => FieldType::Integer,
            PlayerField::BUYBACK_TIMESTAMP_11 => FieldType::Integer,
            PlayerField::BUYBACK_TIMESTAMP_12 => FieldType::Integer,
            PlayerField::KILLS => FieldType::TwoShorts,
            PlayerField::TODAY_CONTRIBUTION => FieldType::Integer,
            PlayerField::YESTERDAY_CONTRIBUTION => FieldType::Integer,
            PlayerField::LIFETIME_HONORABLE_KILLS => FieldType::Integer,
            PlayerField::FIELD_BYTES2 => FieldType::Integer,
            PlayerField::WATCHED_FACTION_INDEX => FieldType::Integer,
            PlayerField::COMBAT_RATING_1 => FieldType::Integer,
            PlayerField::ARENA_TEAM_INFO_1_1 => FieldType::Integer,
            PlayerField::HONOR_CURRENCY => FieldType::Integer,
            PlayerField::ARENA_CURRENCY => FieldType::Integer,
            PlayerField::MAX_LEVEL => FieldType::Integer,
            PlayerField::DAILY_QUESTS_1 => FieldType::Integer,
            ...
            PlayerField::NO_REAGENT_COST_1 => FieldType::Integer,
            PlayerField::GLYPH_SLOTS_1 => FieldType::Integer,
            PlayerField::GLYPH_SLOTS_2 => FieldType::Integer,
            PlayerField::GLYPH_SLOTS_3 => FieldType::Integer,
            PlayerField::GLYPH_SLOTS_4 => FieldType::Integer,
            PlayerField::GLYPH_SLOTS_5 => FieldType::Integer,
            PlayerField::GLYPH_SLOTS_6 => FieldType::Integer,
            PlayerField::GLYPHS_1 => FieldType::Integer,
            PlayerField::GLYPHS_2 => FieldType::Integer,
            PlayerField::GLYPHS_3 => FieldType::Integer,
            PlayerField::GLYPHS_4 => FieldType::Integer,
            PlayerField::GLYPHS_5 => FieldType::Integer,
            PlayerField::GLYPHS_6 => FieldType::Integer,
            PlayerField::GLYPHS_ENABLED => FieldType::Integer,
            PlayerField::PET_SPELL_POWER => FieldType::Integer,
            _ => FieldType::None,
        }
    }
    ...
    pub fn get_field_name(field_index: u32) -> String {
        match field_index {
            ...
            PlayerField::PAD_0 => String::from("PlayerField::PAD_0"),
            PlayerField::INV_SLOT_HEAD => String::from("PlayerField::INV_SLOT_HEAD"),
            PlayerField::INV_SLOT_FIXME1 => String::from("PlayerField::INV_SLOT_FIXME1"),
            PlayerField::INV_SLOT_FIXME2 => String::from("PlayerField::INV_SLOT_FIXME2"),
            PlayerField::INV_SLOT_FIXME3 => String::from("PlayerField::INV_SLOT_FIXME3"),
            PlayerField::INV_SLOT_FIXME4 => String::from("PlayerField::INV_SLOT_FIXME4"),
            PlayerField::INV_SLOT_FIXME5 => String::from("PlayerField::INV_SLOT_FIXME5"),
            PlayerField::INV_SLOT_FIXME6 => String::from("PlayerField::INV_SLOT_FIXME6"),
            PlayerField::INV_SLOT_FIXME7 => String::from("PlayerField::INV_SLOT_FIXME7"),
            PlayerField::INV_SLOT_FIXME8 => String::from("PlayerField::INV_SLOT_FIXME8"),
            PlayerField::INV_SLOT_FIXME9 => String::from("PlayerField::INV_SLOT_FIXME9"),
            PlayerField::INV_SLOT_FIXME10 => String::from("PlayerField::INV_SLOT_FIXME10"),
            PlayerField::INV_SLOT_FIXME11 => String::from("PlayerField::INV_SLOT_FIXME11"),
            PlayerField::INV_SLOT_FIXME12 => String::from("PlayerField::INV_SLOT_FIXME12"),
            PlayerField::INV_SLOT_FIXME13 => String::from("PlayerField::INV_SLOT_FIXME13"),
            PlayerField::INV_SLOT_FIXME14 => String::from("PlayerField::INV_SLOT_FIXME14"),
            PlayerField::INV_SLOT_FIXME15 => String::from("PlayerField::INV_SLOT_FIXME15"),
            PlayerField::INV_SLOT_FIXME16 => String::from("PlayerField::INV_SLOT_FIXME16"),
            PlayerField::INV_SLOT_FIXME17 => String::from("PlayerField::INV_SLOT_FIXME17"),
            PlayerField::INV_SLOT_FIXME18 => String::from("PlayerField::INV_SLOT_FIXME18"),
            PlayerField::INV_SLOT_FIXME19 => String::from("PlayerField::INV_SLOT_FIXME19"),
            PlayerField::INV_SLOT_FIXME20 => String::from("PlayerField::INV_SLOT_FIXME20"),
            PlayerField::INV_SLOT_FIXME21 => String::from("PlayerField::INV_SLOT_FIXME21"),
            PlayerField::INV_SLOT_FIXME22 => String::from("PlayerField::INV_SLOT_FIXME22"),
            PlayerField::PACK_SLOT_1 => String::from("PlayerField::PACK_SLOT_1"),
            PlayerField::BANK_SLOT_1 => String::from("PlayerField::BANK_SLOT_1"),
            PlayerField::BANKBAG_SLOT_1 => String::from("PlayerField::BANKBAG_SLOT_1"),
            PlayerField::VENDORBUYBACK_SLOT_1 => String::from("PlayerField::VENDORBUYBACK_SLOT_1"),
            PlayerField::KEYRING_SLOT_1 => String::from("PlayerField::KEYRING_SLOT_1"),
            PlayerField::CURRENCYTOKEN_SLOT_1 => String::from("PlayerField::CURRENCYTOKEN_SLOT_1"),
            PlayerField::FARSIGHT => String::from("PlayerField::FARSIGHT"),
            PlayerField::KNOWN_TITLES => String::from("PlayerField::KNOWN_TITLES"),
            PlayerField::KNOWN_TITLES1 => String::from("PlayerField::KNOWN_TITLES1"),
            PlayerField::KNOWN_TITLES2 => String::from("PlayerField::KNOWN_TITLES2"),
            PlayerField::KNOWN_CURRENCIES => String::from("PlayerField::KNOWN_CURRENCIES"),
            ...
            PlayerField::COINAGE => String::from("PlayerField::COINAGE"),
            PlayerField::MOD_DAMAGE_DONE_POS => String::from("PlayerField::MOD_DAMAGE_DONE_POS"),
            PlayerField::MOD_DAMAGE_DONE_NEG => String::from("PlayerField::MOD_DAMAGE_DONE_NEG"),
            PlayerField::MOD_DAMAGE_DONE_PCT1 => String::from("PlayerField::MOD_DAMAGE_DONE_PCT1"),
            PlayerField::MOD_DAMAGE_DONE_PCT2 => String::from("PlayerField::MOD_DAMAGE_DONE_PCT2"),
            PlayerField::MOD_DAMAGE_DONE_PCT3 => String::from("PlayerField::MOD_DAMAGE_DONE_PCT3"),
            PlayerField::MOD_DAMAGE_DONE_PCT4 => String::from("PlayerField::MOD_DAMAGE_DONE_PCT4"),
            PlayerField::MOD_DAMAGE_DONE_PCT5 => String::from("PlayerField::MOD_DAMAGE_DONE_PCT5"),
            PlayerField::MOD_DAMAGE_DONE_PCT6 => String::from("PlayerField::MOD_DAMAGE_DONE_PCT6"),
            PlayerField::MOD_DAMAGE_DONE_PCT7 => String::from("PlayerField::MOD_DAMAGE_DONE_PCT7"),
            PlayerField::MOD_HEALING_DONE_POS => String::from("PlayerField::MOD_HEALING_DONE_POS"),
            PlayerField::MOD_HEALING_PCT => String::from("PlayerField::MOD_HEALING_PCT"),
            PlayerField::MOD_HEALING_DONE_PCT => String::from("PlayerField::MOD_HEALING_DONE_PCT"),
            PlayerField::MOD_TARGET_RESISTANCE => String::from("PlayerField::MOD_TARGET_RESISTANCE"),
            PlayerField::MOD_TARGET_PHYSICAL_RESISTANCE => String::from("PlayerField::MOD_TARGET_PHYSICAL_RESISTANCE"),
            ...
            PlayerField::PVP_MEDALS => String::from("PlayerField::PVP_MEDALS"),
            PlayerField::BUYBACK_PRICE_1 => String::from("PlayerField::BUYBACK_PRICE_1"),
            PlayerField::BUYBACK_PRICE_2 => String::from("PlayerField::BUYBACK_PRICE_2"),
            PlayerField::BUYBACK_PRICE_3 => String::from("PlayerField::BUYBACK_PRICE_3"),
            PlayerField::BUYBACK_PRICE_4 => String::from("PlayerField::BUYBACK_PRICE_4"),
            PlayerField::BUYBACK_PRICE_5 => String::from("PlayerField::BUYBACK_PRICE_5"),
            PlayerField::BUYBACK_PRICE_6 => String::from("PlayerField::BUYBACK_PRICE_6"),
            PlayerField::BUYBACK_PRICE_7 => String::from("PlayerField::BUYBACK_PRICE_7"),
            PlayerField::BUYBACK_PRICE_8 => String::from("PlayerField::BUYBACK_PRICE_8"),
            PlayerField::BUYBACK_PRICE_9 => String::from("PlayerField::BUYBACK_PRICE_9"),
            PlayerField::BUYBACK_PRICE_10 => String::from("PlayerField::BUYBACK_PRICE_10"),
            PlayerField::BUYBACK_PRICE_11 => String::from("PlayerField::BUYBACK_PRICE_11"),
            PlayerField::BUYBACK_PRICE_12 => String::from("PlayerField::BUYBACK_PRICE_12"),
            PlayerField::BUYBACK_TIMESTAMP_1 => String::from("PlayerField::BUYBACK_TIMESTAMP_1"),
            PlayerField::BUYBACK_TIMESTAMP_2 => String::from("PlayerField::BUYBACK_TIMESTAMP_2"),
            PlayerField::BUYBACK_TIMESTAMP_3 => String::from("PlayerField::BUYBACK_TIMESTAMP_3"),
            PlayerField::BUYBACK_TIMESTAMP_4 => String::from("PlayerField::BUYBACK_TIMESTAMP_4"),
            PlayerField::BUYBACK_TIMESTAMP_5 => String::from("PlayerField::BUYBACK_TIMESTAMP_5"),
            PlayerField::BUYBACK_TIMESTAMP_6 => String::from("PlayerField::BUYBACK_TIMESTAMP_6"),
            PlayerField::BUYBACK_TIMESTAMP_7 => String::from("PlayerField::BUYBACK_TIMESTAMP_7"),
            PlayerField::BUYBACK_TIMESTAMP_8 => String::from("PlayerField::BUYBACK_TIMESTAMP_8"),
            PlayerField::BUYBACK_TIMESTAMP_9 => String::from("PlayerField::BUYBACK_TIMESTAMP_9"),
            PlayerField::BUYBACK_TIMESTAMP_10 => String::from("PlayerField::BUYBACK_TIMESTAMP_10"),
            PlayerField::BUYBACK_TIMESTAMP_11 => String::from("PlayerField::BUYBACK_TIMESTAMP_11"),
            PlayerField::BUYBACK_TIMESTAMP_12 => String::from("PlayerField::BUYBACK_TIMESTAMP_12"),
            PlayerField::KILLS => String::from("PlayerField::KILLS"),
            PlayerField::TODAY_CONTRIBUTION => String::from("PlayerField::TODAY_CONTRIBUTION"),
            PlayerField::YESTERDAY_CONTRIBUTION => String::from("PlayerField::YESTERDAY_CONTRIBUTION"),
            PlayerField::LIFETIME_HONORABLE_KILLS => String::from("PlayerField::LIFETIME_HONORABLE_KILLS"),
            PlayerField::FIELD_BYTES2 => String::from("PlayerField::FIELD_BYTES2"),
            PlayerField::WATCHED_FACTION_INDEX => String::from("PlayerField::WATCHED_FACTION_INDEX"),
            PlayerField::COMBAT_RATING_1 => String::from("PlayerField::COMBAT_RATING_1"),
            PlayerField::ARENA_TEAM_INFO_1_1 => String::from("PlayerField::ARENA_TEAM_INFO_1_1"),
            PlayerField::HONOR_CURRENCY => String::from("PlayerField::HONOR_CURRENCY"),
            PlayerField::ARENA_CURRENCY => String::from("PlayerField::ARENA_CURRENCY"),
            PlayerField::MAX_LEVEL => String::from("PlayerField::MAX_LEVEL"),
            PlayerField::DAILY_QUESTS_1 => String::from("PlayerField::DAILY_QUESTS_1"),
            ...
            PlayerField::GLYPH_SLOTS_1 => String::from("PlayerField::GLYPH_SLOTS_1"),
            PlayerField::GLYPH_SLOTS_2 => String::from("PlayerField::GLYPH_SLOTS_2"),
            PlayerField::GLYPH_SLOTS_3 => String::from("PlayerField::GLYPH_SLOTS_3"),
            PlayerField::GLYPH_SLOTS_4 => String::from("PlayerField::GLYPH_SLOTS_4"),
            PlayerField::GLYPH_SLOTS_5 => String::from("PlayerField::GLYPH_SLOTS_5"),
            PlayerField::GLYPH_SLOTS_6 => String::from("PlayerField::GLYPH_SLOTS_6"),
            PlayerField::GLYPHS_1 => String::from("PlayerField::GLYPHS_1"),
            PlayerField::GLYPHS_2 => String::from("PlayerField::GLYPHS_2"),
            PlayerField::GLYPHS_3 => String::from("PlayerField::GLYPHS_3"),
            PlayerField::GLYPHS_4 => String::from("PlayerField::GLYPHS_4"),
            PlayerField::GLYPHS_5 => String::from("PlayerField::GLYPHS_5"),
            PlayerField::GLYPHS_6 => String::from("PlayerField::GLYPHS_6"),

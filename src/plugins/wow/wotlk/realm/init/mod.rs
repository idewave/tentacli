...
impl Processor for InitProcessor {
    fn get_handlers(
        ...
        Ok(match opcode {
            Opcode::SMSG_AUTH_CHALLENGE => vec![Box::new(auth_challenge::Handler)],
            ...
            Opcode::SMSG_MOTD => vec![Box::new(motd::Handler)],
            Opcode::SMSG_LOGIN_SETTIMESPEED => vec![Box::new(set_time_speed::Handler)],
            Opcode::SMSG_WEATHER => vec![Box::new(set_weather::Handler)],
            Opcode::SMSG_INIT_WORLD_STATES => vec![Box::new(init_world_states::Handler)],
            ...
            Opcode::SMSG_ADDON_INFO => vec![Box::new(addon_info::Handler)],
            _ => vec![],
        })
    }
}
